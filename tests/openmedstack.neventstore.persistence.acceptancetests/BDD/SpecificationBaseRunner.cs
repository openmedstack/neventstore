...
//                {
//                    if (fixtureData is IDisposable disposable)
//                    {
//                        disposable.Dispose();
//                    }
//                }
...
//                        if (genericDefinition == typeof(IClassFixture<>))
//                        {
...
//                    "SpecificationBaseRunner can only be used with types that derive from SpecificationBase");
//            }
//        }
...
//                {
//                    throw new InvalidOperationException(
//                        "Observation " + TypeName + "." + MethodName + " cannot have parameters");
//                }
